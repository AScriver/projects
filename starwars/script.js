...
Choose Character
     |
     V
Move Available Opponents To Respective Area
     |
     V
Select Opponent
     |
...
Attack Opponent <---------------------------------------------------------
     |                                                                   |
     |---(opponent HP > 0?)---> Opponent Attacks PLayer --->(userAttack = Userattack * turncount)
     |
     V
Defeated Opponent moves to graveyard
     |
     V
if user HP = 0 -> lose
if user HP > 0 && no enemies -> win
if user HP > 0 && enemies ---> select living opponent
*/


$(document).ready(function () {
    // declare character object variable
    var characters = {
        "Anakin Skywalker": {
